...
if uploaded_file:
    ...
    def compute_metrics(group):
        ...
        # UPDATED Logic for Lowest 4: Filter out zeros, then find the average of the 4 smallest non-zero values
    ...
    with tab_ordering_worksheet:
        ...
        # Updated the radio button options to reflect the new metric name
